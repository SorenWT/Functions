...
settings = struct;
settings.pseudo.prestim = 501:550; 
settings.pseudo.poststim= 551:950; 
settings.real.prestim = 951:1000; 
...
%             rest{c} = ft_freqsimulation_swt(cfg);
	    ...
	    cfg.osci.s1.freq = 3;
            ...
            for cc = 1:128
                ...
                corrfact{i}(cc) = 1*(rand+0.625);
                evo{i}(cc,:) = [zeros(1,1000) corrfact{i}(cc)*sin((1:150)*pi/150) exp(-(1:850)./150)];
            end
...
for c = 1:length(mvals)
    opts.minnbchan = 0; opts.nrand = 1000; opts.distmethod = 'distance'; opts.parpool = 48;
...
prestim_pseudo = 501:550; poststim_pseudo = 551:950; prestim_real = 951:1000; poststim_real = 1001:1400;
