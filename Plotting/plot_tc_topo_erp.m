function plot_erp_clusts(data,clust,settings,p,pindx,varargin)
...
for i = 1:nclusts
    ...
    plotindx = linspace(0,length(clust.time),5);
    ...
    for cc = 1:4
        p(pindx{:},2,plothelper(cc,1),plothelper(cc,2)).select()
